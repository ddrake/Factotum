namespace Factotum
{
	partial class MeterView
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MeterView));
			...
			this.dgvMeters = new Factotum.DataGridViewStd();
            ...
            "Active",
            "Inactive"});
			this.cboStatusFilter.Location = new System.Drawing.Point(309, 6);
			...
			this.dgvMeters.AllowUserToOrderColumns = true;
			this.dgvMeters.AllowUserToResizeRows = false;
			...
			this.dgvMeters.Location = new System.Drawing.Point(12, 90);
			...
			this.dgvMeters.Size = new System.Drawing.Size(404, 131);
			this.dgvMeters.StandardTab = true;
			this.dgvMeters.TabIndex = 6;
			this.dgvMeters.DoubleClick += new System.EventHandler(this.btnEdit_Click);
			this.dgvMeters.KeyDown += new System.Windows.Forms.KeyEventHandler(this.dgvMeters_KeyDown);
			// 
			// panel1
			// 
			...
			this.panel1.Size = new System.Drawing.Size(399, 36);
			...
			this.Name = "MeterView";
			this.Text = " View Meters";
			this.Load += new System.EventHandler(this.MeterView_Load);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.MeterView_FormClosed);
		...
		private DataGridViewStd dgvMeters;
	}
}