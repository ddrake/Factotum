namespace Factotum
{
	partial class InspectorView
	{
		...
		private void InitializeComponent()
		{
			...
			this.dgvInspectors = new Factotum.DataGridViewStd();
			...
			this.label1.Text = "Inspector List";
			// 
			// btnAdd
			// 
            ...
            "Active",
            "Inactive"});
			this.cboStatusFilter.Location = new System.Drawing.Point(208, 6);
			...
			this.dgvInspectors.AllowUserToOrderColumns = true;
			this.dgvInspectors.AllowUserToResizeRows = false;
			this.dgvInspectors.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
							| System.Windows.Forms.AnchorStyles.Left)
							| System.Windows.Forms.AnchorStyles.Right)));
			this.dgvInspectors.Location = new System.Drawing.Point(12, 90);
			this.dgvInspectors.MultiSelect = false;
			this.dgvInspectors.Name = "dgvInspectors";
			this.dgvInspectors.ReadOnly = true;
			this.dgvInspectors.RowHeadersVisible = false;
			this.dgvInspectors.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgvInspectors.Size = new System.Drawing.Size(303, 131);
			this.dgvInspectors.StandardTab = true;
			this.dgvInspectors.TabIndex = 6;
			this.dgvInspectors.DoubleClick += new System.EventHandler(this.btnEdit_Click);
            ...
            "All",
            "Yes"});
			this.cboInOutageFilter.Location = new System.Drawing.Point(65, 6);
			...
			this.Text = " View Inspectors";
			this.Load += new System.EventHandler(this.InspectorView_Load);
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.InspectorView_FormClosed);
		...
		private DataGridViewStd dgvInspectors;
	}
}